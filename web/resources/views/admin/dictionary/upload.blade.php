...
@section('title', 'Dictionary Upload - SkinQuo Admin')
...
<div class="sg-page">
  ...
  <div class="sg-header">
    ...
    <p>Drag and drop CSV files to update system dictionaries. Ensure formats match the required schema to maintain data integrity.</p>
  </div>
