...
@section('title', 'Ubah Password — SkinQuo')

@push('styles')
<style>
    /* ══════════════════════════════════════
       CHANGE PASSWORD PAGE — SkinQuo
       "Secure Your Sanctuary"
    ══════════════════════════════════════ */

    body { background: #FFEAC5; }

    /* Hide navbar if needed (optional) */
    ...
    .cp-input::placeholder {
        color: rgba(96, 63, 38, 0.28);
        letter-spacing: 0.01em;
        font-weight: 400;
    }
    .cp-input:focus {
        background: rgba(96, 63, 38, 0.08);
        box-shadow: 0 0 0 2px rgba(96, 63, 38, 0.15);
    }
    .cp-input[type="password"] {
        letter-spacing: 0.2em;
        font-size: 1rem;
    }
    .cp-input[type="text"].revealed {
        letter-spacing: 0.02em;
        font-size: 0.88rem;
    }
    .cp-input:read-only {
        color: rgba(96, 63, 38, 0.35);
        cursor: not-allowed;
        background: rgba(96, 63, 38, 0.06);
    }
    ...
    .cp-check-item.met .cp-check-icon::after {
        display: block;
    }
    ...
    .cp-submit-btn:hover {
        ...
        box-shadow: 0 6px 16px rgba(96, 63, 38, 0.2);
    }
...
<div class="cp-main">
    ...
    <div class="cp-form-wrap">
        ...
        <form method="POST" action="{{ route('profile.password.update') }}" id="cpForm">
            ...
            {{-- Username (readonly) --}}
            <div class="cp-field">
                <label class="cp-field-label">User Name</label>
            ...
            <div class="cp-field">
                ...
                <div class="cp-input-wrap">
                    ...
                    >
                    <button type="button" class="cp-eye-btn" data-target="current_password" aria-label="Toggle password visibility">
            ...
            <div class="cp-field">
                ...
                <div class="cp-input-wrap">
                    ...
                    >
                    <button type="button" class="cp-eye-btn" data-target="password" aria-label="Toggle password visibility">
                        <svg class="eye-show" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
                            <circle cx="12" cy="12" r="3"/>
                        </svg>
            ...
            <div class="cp-field" style="margin-bottom:0;">
                <label class="cp-field-label" for="password_confirmation">Confirm New Password</label>
                <div class="cp-input-wrap">
                    <input
                        type="password"
                        ...
                        autocomplete="new-password"
                    >
                    <button type="button" class="cp-eye-btn" data-target="password_confirmation" aria-label="Toggle password visibility">
                        <svg class="eye-show" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
                            <circle cx="12" cy="12" r="3"/>
                        </svg>
...
<script>
    ...
    // Show success/error toast on page load if session has status
    ...
    function updateStrength(val) {
        ...
        if (hasUpper)           score++;
        if (hasSymbol || hasNum) score++;

        var levels = [
            { pct: 0,    label: '—',           color: '#603F26' },
